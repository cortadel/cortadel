 ...
 */
export interface CortadelApiClient extends BaseRequestBuilder<CortadelApiClient> {
    /**
     * The api property
     */
...
/**
 * Instantiates a new {@link CortadelApiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createCortadelApiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<CortadelApiClient>(requestAdapter, pathParameters, CortadelApiClientNavigationMetadata, undefined);
}
/**
 * Uri template for the request builder.
 */
export const CortadelApiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const CortadelApiClientNavigationMetadata: Record<Exclude<keyof CortadelApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
