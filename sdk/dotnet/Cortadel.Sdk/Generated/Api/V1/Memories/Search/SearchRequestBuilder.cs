...
using System;
namespace Cortadel.Sdk.Generated.Api.V1.Memories.Search
{
    /// <summary>
    ...
    internal partial class SearchRequestBuilder : BaseRequestBuilder
    {
        ...
        public SearchRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v1/memories/search", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Cortadel.Sdk.Generated.Api.V1.Memories.Search.SearchRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SearchRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v1/memories/search", rawUrl)
        {
        }
        /// <summary>
        /// Search memories using hybrid vector + keyword search.
        /// </summary>
        /// <returns>A <see cref="global::Cortadel.Sdk.Generated.Models.SearchResponse"/></returns>
        /// <param name="body">Hybrid search request.</param>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Cortadel.Sdk.Generated.Models.SearchMemoriesRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Cortadel.Sdk.Generated.Models.SearchMemoriesRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Cortadel.Sdk.Generated.Api.V1.Memories.Search.SearchRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Cortadel.Sdk.Generated.Api.V1.Memories.Search.SearchRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Cortadel.Sdk.Generated.Api.V1.Memories.Search.SearchRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
