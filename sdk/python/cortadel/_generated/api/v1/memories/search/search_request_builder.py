...
if TYPE_CHECKING:
    ...
    from .....models.search_memories_request import SearchMemoriesRequest
...
class SearchRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/v1/memories/search", path_parameters)
    
    async def post(self,body: SearchMemoriesRequest, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[SearchResponse]:
        """
    ...
    def to_post_request_information(self,body: SearchMemoriesRequest, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Search memories using hybrid vector + keyword search.
        param body: Hybrid search request.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
