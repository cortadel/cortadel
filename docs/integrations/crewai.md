...
- `cortadel` **≥ 1.0, < 2.0** — the [Python SDK](../sdk-python.md), pulled in automatically.
- A running Cortadel server: the hosted service at `https://app.cortadel.ai`, or your own
  (`docker compose up` → `http://localhost:3001`, see [Self-hosting](../self-hosting.md)). Mint the
  API key it needs with [Authentication](../authentication.md).
