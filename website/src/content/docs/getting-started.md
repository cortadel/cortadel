...
runs the container alone — see [Self-hosting](/self-hosting/) to wire a graph DB + providers.
:::
...
:::tip[Prefer Python or TypeScript?]
`pip install cortadel` — see the [Python SDK reference](/sdk-python/) — or
`npm install @cortadel/sdk` — see the [TypeScript SDK reference](/sdk-typescript/) — for the
...
- [TypeScript SDK reference](/sdk-typescript/) — every method, option, and model.
