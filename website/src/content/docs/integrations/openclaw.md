---
title: Cortadel × OpenClaw
description: An OpenClaw plugin that adds Cortadel as an additive memory corpus, two agent tools, and automatic recall/capture hooks around every turn.
---
...
- [All integrations](/integrations/) — the other eleven frameworks.
