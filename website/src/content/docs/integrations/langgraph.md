---
title: Cortadel × LangGraph
description: Cortadel as a LangGraph BaseStore, plus search_memory / add_memories tools and recall/persist hooks for createReactAgent.
---
...
- **A running Cortadel server** — hosted at `https://app.cortadel.ai`, or self-hosted with
  ...
  See [Self-hosting](/self-hosting/) and [Authentication](/authentication/).
