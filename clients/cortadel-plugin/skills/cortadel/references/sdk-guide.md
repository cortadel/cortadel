...
of them are reachable through `search()`/`SearchAsync()` in `1.0.0` of any SDK. Call
...
These are real gaps in the current `1.0.0` surface, not hypothetical edge cases. Cite them rather
